    ...
    >
      <div className="space-y-16">
        ...
        <motion.div
          ...
          className="cta-referral relative overflow-hidden rounded-[42px] border border-white/10 bg-gradient-to-br from-background/70 via-background/50 to-background/80 p-10 shadow-[0_25px_100px_rgba(236,72,153,0.2)] my-20"
        >
