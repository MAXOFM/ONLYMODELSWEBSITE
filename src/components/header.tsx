...
export function Header() {
  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-6 z-30 flex justify-center px-4">
      <div className="nav-shell pointer-events-auto flex items-center gap-3 w-full max-w-[1350px] justify-between max-[500px]:px-4 max-[500px]:rounded-full max-[500px]:border max-[500px]:border-[#ff1493] max-[500px]:border-white/10 max-[500px]:bg-white/5 max-[500px]:backdrop-blur-md"> 
